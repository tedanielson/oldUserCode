...
vector< vector<int> > MakeVRunLumi(string input){
	...
	if(input == "Golden" || input == "Prompt"){
		...
		orgJSON.open("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions12/8TeV/Prompt/Cert_190456-208686_8TeV_PromptReco_Collisions12_JSON_MuonPhys.txt");
	}
