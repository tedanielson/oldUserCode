...
#include "trigger.C"
  ...
  c1->Print("PFNoPUHT350_Mu15_PFMET45_MET_eff_2012C_24Aug.eps");
  ...
  c1->Print("PFNoPUHT400_Mu5_PFMET45_MET_eff_2012C_24Aug.eps");
  ...
  c1->Print("PFNoPUHT350_Mu15_PFMET45_HT_MET_eff_2012C_24Aug.eps");
