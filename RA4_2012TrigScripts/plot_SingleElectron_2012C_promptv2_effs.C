...
#include "trigger.C"
  ...
  TFile f0("SingleElectron_HT_MET_effs_2012C_Promptv2.root");
  ...
  c1->Print("CleanPFNoPUHT300_Ele15_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_PFMET45_MET_eff_2012C_Promptv2.eps");
  ...
  c1->Print("CleanPFNoPUHT350_Ele5_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_PFMET45_MET_eff_2012C_Promptv2.eps");
  ...
  c1->Print("CleanPFNoPUHT300_Ele40_CaloIdT_TrkIdT_HT_eff_2012C_Promptv2.eps");
  ...
  c1->Print("CleanPFNoPUHT300_Ele15_CaloIdT_CaloIsoVL_TrkIdT_TrkIsoVL_PFMET45_HT_MET_eff_2012C_Promptv2.eps"); 
