...
#include "trigger.C"
  ...
  c1->Print("PFHT350_Mu15_PFMET45_MET_eff_2012B.eps");
  ...
  c1->Print("PFHT400_Mu5_PFMET45_MET_eff_2012B.eps");
  ...
  c1->Print("PFHT350_Mu15_PFMET45_HT_MET_eff_2012B.eps");
