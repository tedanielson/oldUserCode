...
process.endPath = cms.EndPath(process.exoticaMuOutputModule+process.singlePhotonOutputModule+process.singleJetOutputModule+process.singleMETOutputModule)
