#ifndef Workspace_DataSkim_TagProbeMassProducer_h
#define Workspace_DataSkim_TagProbeMassProducer_h
// -*- C++ -*-
//
// Package:     TagAndProbe
...
// $Id: TagProbeMassProducer.h,v 1.4 2009/09/22 19:43:23 ahunt Exp $
//
