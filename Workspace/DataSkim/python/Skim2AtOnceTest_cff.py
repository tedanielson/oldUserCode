...
muonTagProbeMap = cms.EDProducer("TagProbeMassProducer",
...
TPFilter = cms.EDFilter("TagProbeMassEDMFilter",
                        tpMapName = cms.string('muonTagProbeMap')
                        )

#Define group sequence, using HLT/Reco quality cut. 
#exoticaMuHLTQualitySeq = cms.Sequence()
SecondMuRecoQualitySeq = cms.Sequence(
    #exoticaMuHLT+
    allTracks+staTracks*tagCands+tkProbeCands+staCands*TkStaMap*TkStaMatched+muonTagProbeMap+TPFilter
    )
